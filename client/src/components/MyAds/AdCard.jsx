  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="text-gray-700 text-sm line-clamp-2 mb-3">{ad.description || "Açıklama bulunmuyor"}</p>
        <div className="flex justify-between items-center">
          <span className="text-xs text-gray-700">{ad.priceType || "saatlik"}</span>
        </div>
      </div>
