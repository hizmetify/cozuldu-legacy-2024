...
import { emailVerify, resendVerificationCode } from '../../api/authApi';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response?.status === 'success') {
        showToast({ message: 'E-posta başarıyla doğrulandı', type: 'success' });
        navigate('/dashboard/my-ads/new');
      } else {
        setMessage('Girilen kod hatalı');
        showToast({ message: 'Doğrulama başarısız', type: 'error' });
      }
    } catch (error) {
